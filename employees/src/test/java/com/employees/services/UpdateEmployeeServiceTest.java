...
class UpdateEmployeeServiceTest {
	...
	public void empUpdate_updateOwnData_shouldCallDao() {
		...
		Employee emp=new Employee(
				"TEK1","8765432123","rohith@gmail.com");
	...
	public void empUpdate_updateOtherData_shouldThrowsException() {
		...
		LoginResult login=new LoginResult("TEK1",roles);
		Employee emp=new Employee(
				"TEK12","8765432123","rohith@gmail.com");
		AuthorizedException exception=assertThrows(AuthorizedException.class,()->updateEmp.update(employeeDao, emp, login));
	...
	public void empUpdate_InvalidEmail_shouldThrowsException() {
		...
		LoginResult login=new LoginResult("TEK1",roles);
		Employee emp=new Employee(
				"TEK1","8765432123","rohithgmail.com");
		ValidationException exception=assertThrows(ValidationException.class,()->updateEmp.update(employeeDao, emp, login));
	...
	void adminUpdate_validEmployee_shouldUpdateWithAdminRole() {
	    ...
	    Employee emp = new Employee(
	            "TEK2", "Sunny", "IT", "sunny@gmail.com", "8765432123");
